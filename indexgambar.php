          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="indexuser.php" data-toggle="search" class="hidden-xs">
                    ...
                    <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="tampilpengeluaran.php">Pengeluaran</a></li>
                            <li><a href="tampilpendapatan.php">Pendapatan</a></li>
                            <li><a href="tingkatkesejahteraan.php">Tingkat kesejahteraan</a></li>
                          </ul>
                    </li>
                    ...
                    <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="riwayatpertanian.php">Riwayat Pertanian</a></li>
                            <li><a href="Penyuluhan.php">Penyuluhan</a></li>
                    ...
                    <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="tampilan.php">Info Tanaman</a></li>
                            <li><a href="pupuk.php">Info Pupuk</a></li>
                            <li><a href="penjual.php">Info Penjual</a></li>
                          </ul>
                    </li>
                         ...
                         <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><!--<a href="edit.php">edit</a>  -->
                              <a href="edit.php?ni=<?php echo $_SESSION['nama'];?>" name="edit">edit</a>
                              </li>
...
<body style="background-color:#bdc3c7">
	...
	<div id="content" align="center">
					...
					<table align="left">
							...
							<?php 
							$id_gbr=$_REQUEST['id_gbr'];
							$nama =$_REQUEST['nama'];
							$nama_gambar=$_REQUEST['nama_gambar'];
							
								// menampilkan data yang ada di database
								$conn=mysqli_connect("localhost","root","");
								$db=mysqli_select_db( $conn, "pertanian");
								$query_tampil = mysqli_query($conn,"select * from upload_gambar "); // deklarasi query tampil untuk mnyeleksi keseluruhan field dalam table
								...
								while ( $fetch_tampil = mysqli_fetch_array($query_tampil)) { // mengambil value dari database dengan array
                                    ...
                                    <td > <a href="hapus.php?id_gbr=<?php echo $fetch_tampil[0]; ?>"> Hapus</a></td>
                                                </div>
                                        </div>
                        </td>
                        </tr>
